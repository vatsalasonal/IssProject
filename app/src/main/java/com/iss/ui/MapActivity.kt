...
import com.iss.utils.LocationDateConverter
...
class MapActivity : FragmentActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        model.issInfo.observe(this, Observer {
            ...
            var locationName = LocationDateConverter.getLocationName(
                it?.iss_position.latitude!!, it?.iss_position.longitude!!, this, geocoder)
            var issLocationTimes = IssPeopleDate(AstronautIssLocationTimeAdapter.VIEW_TYPE_TWO,
                locationName, LocationDateConverter.getDate(it.timestamp!!).toString())
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        val latLng = LatLng(currentLocation.latitude, currentLocation.longitude)
        var locationName = LocationDateConverter.getLocationName(
            latLng.latitude, latLng.longitude, this, geocoder)
        textViewDistance.text = locationName
